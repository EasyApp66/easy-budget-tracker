...
export default function Budget() {
  ...
  return <div className="min-h-screen bg-background pb-32 safe-top">
      <div className="px-4 pt-6 space-y-4">
        ...
        {!activeMonth && <div className="text-center py-12 text-muted-foreground">
      ...
      <EditModal isOpen={showEditTitle} onClose={() => setShowEditTitle(false)} onSave={value => setBudgetTitle(String(value))} title="Titel anpassen" currentValue={budgetTitle} type="text" />
